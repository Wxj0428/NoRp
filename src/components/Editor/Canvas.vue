  ...
  <div class="canvas-container h-full w-full relative overflow-hidden bg-gray-700">
    ...
    >
      ...
      >
        ...
        <div
          v-if="editorStore.isCanvasBusy"
          class="absolute inset-0 bg-black/20 flex items-center justify-center z-20 pointer-events-none transition-opacity duration-300"
        >
          <div class="bg-gray-800/90 backdrop-blur-sm px-4 py-2 rounded-lg flex items-center gap-2 shadow-lg">
            <svg class="w-4 h-4 animate-spin text-blue-400" fill="none" viewBox="0 0 24 24">
              <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
              <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
            </svg>
            <span class="text-sm text-gray-300">AI 正在生成...</span>
          </div>
        </div>
      </div>
    </div>
